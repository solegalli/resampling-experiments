...
- **~21 papers** here. The foundational/critique rows came from an adversarially-verified search; the empirical comparison studies were added from Sole's review (her reading). The Informatics in Medicine Unlocked and the J Big Data 2023 (observational health data) rows still need their exact author citations confirmed.
