"""
Evaluate pre-trained special ensemble classifiers on various imbalanced datasets.

Loads each model saved by train-resampling-ensembles.py, evaluates it on the test set
...
MODELS_DIR = REPO_ROOT / "models" / "special-ensembles"
